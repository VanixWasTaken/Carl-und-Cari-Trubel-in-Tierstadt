...
##################################  WRITE DIALOG HERE  ###################################
	...
	if dialogs == 3:
		...
		if Global.character == "Carl":
			...
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Carl/PC/vo_pc_carl_tutorial03_var1.mp3")
			$"../Voice Over".play()
		elif Global.character == "Cari":
			short_node_name.text = "Cari"
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Cari/PC/vo_pc_cari_tutorial03_var1.mp3")
			$"../Voice Over".play()
...
##################################  WRITE DIALOG HERE  ###################################
	...
	if dialogs == 1:
		...
		if Global.character == "Carl":
			short_node_name.text = "Cari"
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Cari/NPC/vo_npc_cari_tutorial04_var1.mp3")
			$"../Voice Over".play()
		elif Global.character == "Cari":
			short_node_name.text = "Carl"
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Carl/NPC/vo_npc_carl_tutorial04_var1.mp3")
			$"../Voice Over".play()
		...
		if Global.character == "Carl":
			short_node_name.text = "Cari"
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Cari/NPC/vo_npc_cari_tutorial05_var1.mp3")
			$"../Voice Over".play()
		elif Global.character == "Cari":
			short_node_name.text = "Carl"
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Carl/NPC/vo_npc_carl_tutorial05_var1.mp3")
			$"../Voice Over".play()
