...
##################################  WRITE DIALOG HERE  ###################################
	...
	if dialogs == 1:
		...
		short_node_text.text = "Ah, hab ihn gefunden. Jetzt bin ich bereit zu gehen."
		short_node_rect.texture = PRESET1
		dialogs += 1
		if Global.character == "Carl":
			short_node_name.text = "Carl"
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Carl/PC/vo_pc_carl_tutorial02_var1.mp3")
			$"../Voice Over".play()
		elif Global.character == "Cari":
			short_node_name.text = "Cari"
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Cari/PC/vo_pc_cari_tutorial02_var1.mp3")
			$"../Voice Over".play()
...
##################################  WRITE DIALOG HERE  ###################################
	...
	if dialogs == 2:
		...
		var short_node_rect = short_node.get_child(1)
		var short_node_name = short_node.get_child(3).get_child(0)
		short_node_text.text = "Perfekt, komm noch kurz zu mir und sprich mit mir."
		short_node_rect.texture = PRESET2
		short_node_rect.flip_h = true
		dialogs += 1
		if Global.character == "Carl":
			short_node_name.text = "Cari"
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Cari/NPC/vo_npc_cari_tutorial03_var1.mp3")
			$"../Voice Over".play()
		elif Global.character == "Cari":
			short_node_name.text = "Carl"
			$"../Voice Over".stream = load("res://Assets/Sound/VO/Tutorial/Dialogue/Carl/NPC/vo_npc_carl_tutorial03_var1.mp3")
			$"../Voice Over".play()
