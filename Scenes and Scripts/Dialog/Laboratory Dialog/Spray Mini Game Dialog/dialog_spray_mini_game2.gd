...
##################################  WRITE DIALOG HERE  ###################################
	...
	if dialogs == 1:
		...
		short_node_text.text = "Schraubt a-a-als erstes die Mischung an die Spritzpistole."
		short_node_rect.texture = PRESET3
		short_node_name.text = "Christina"
		$"../VoiceOver".stream = load("res://Assets/Sound/VO/Laboratory/Chameleon/vo_npc_chameleon_laboratory_spray_05.mp3")
		$"../VoiceOver".play()
		dialogs += 1
