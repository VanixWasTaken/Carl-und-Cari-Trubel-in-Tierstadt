...
##################################  WRITE DIALOG HERE  ###################################
	...
	if dialogs == 1:
		...
		short_node_text.text = "Gute Arbeit ihr zwei. Jetzt können wir die Pflanzen auch auf dem Stadtfest ausstellen."
		short_node_rect.texture = PRESET4
		short_node_name.text = "Guido"
		$"../VoiceOver".stream = load("res://Assets/Sound/VO/Garden Center/Guido/vo_npc_guido_snipping_dialog_13.mp3")
		$"../VoiceOver".play()
		dialogs += 1
		same_speaker = false
