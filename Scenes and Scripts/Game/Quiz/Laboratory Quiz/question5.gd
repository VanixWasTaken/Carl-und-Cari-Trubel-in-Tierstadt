...
func _on_star_pressed():
	...
	Global.job_stars_dict["ChemistJob"] = 1
...
func _on_star_2_pressed():
	...
	$Star5/SelectedStar.hide()
	selected_something = true
	Global.job_stars_dict["ChemistJob"] = 2
...
func _on_star_3_pressed():
	...
	$Star5/SelectedStar.hide()
	selected_something = true
	Global.job_stars_dict["ChemistJob"] = 3
...
func _on_star_4_pressed():
	...
	$Star5/SelectedStar.hide()
	selected_something = true
	Global.job_stars_dict["ChemistJob"] = 4
...
func _on_star_5_pressed():
	...
	selected_something = true
	Global.job_stars_dict["ChemistJob"] = 5
